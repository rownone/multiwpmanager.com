...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><?php echo Yii::app()->params['site_title'] ?></a>
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
                            ...
                            //array('label'=>'Manage Apps', 'url'=>array('/apps/apps'), 'visible'=>!Yii::app()->user->isGuest),
                            //array('label'=>'Users', 'url'=>array('/admin/users'), 'visible'=>!Yii::app()->user->isGuest),
							//array('label'=>'About', 'url'=>array('/home/page', 'view'=>'about')),
    ...
    <?php
        ...
        $isFrontpage = false;
        if ((Yii::app()->controller->getId().'/'.Yii::app()->controller->getAction()->getId()) == $default_controller.'/index'  ) { 
            $isFrontpage = true;
        }
